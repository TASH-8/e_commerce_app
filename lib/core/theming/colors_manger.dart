...
class ColorManger {
  ...
  static Color greyshade100 = const Color(0xffF5F6F8) ;

  static Color lightTurquoiseFade = const Color(0xFF79E1F4);
  static Color oeeperBlueFade = const Color(0xFF3DA6F0);
  static Color orangeFade = const Color.fromARGB(255, 254, 187, 51);
  static Color redFade = const Color(0xFFFF4E00);
  static Color greenFade = const Color.fromARGB(255, 51, 255, 0);
  static Color deeperGreenFade = const Color(0xFF37C445);
  static Color greyCustomShade = const Color(0xFF515B6E);
  static Color pinkCustom = const Color(0xFFED5199);
  static Color orangeCustom = const Color(0xFFFF8C69);
  static Color blueCustom = const Color(0xFF67B5F7);
  static const greyCustom = Color(0xFFC9C9C9);
  static Color blackCustom = const Color(0xFF3E3A3A);
